...
CREATE TABLE country (
  ...
  Continent VARCHAR(13) NOT NULL CHECK (Continent IN ('Asia', 'Europe', 'North America', 'Africa', 'Oceania', 'Antarctica', 'South America')),
  Region CHAR(26) NOT NULL,
  SurfaceArea FLOAT8 NOT NULL DEFAULT 0.00,
  IndepYear SMALLINT,
  Population INT NOT NULL DEFAULT 0,
...
CREATE TABLE countrylanguage (
  ...
  Percentage FLOAT4 NOT NULL DEFAULT 0.0,
...
-- basic descriptive statistics of the population in city table

SELECT AVG(population) AS avg_population, 
  MIN(population) AS min_population, 
  MAX(population) AS max_population, 
  STDDEV(population) AS std_population 
FROM city;

--top 10 cities with the largest populations.
 SELECT name, population 
FROM city
ORDER BY population DESC 
LIMIT 10;

--top 10 cities with the smallest populations.
 SELECT name, population 
FROM city 
...
SELECT district, SUM(population) AS district_total_population 
FROM city
GROUP BY district 
ORDER BY district_total_population DESC;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
--Number of Cities per District; Count the number of cities in each district.
...
--ANALYSIS OF COUNTRY TABLE

--Dscriptive statistics of population in country table 
SELECT 
...
--top 10 countries with the highest populations
 SELECT name, population 
FROM country
ORDER BY population DESC 
LIMIT 10;

--top 10 countries with the lowest populations.
 SELECT name, population 
FROM country
ORDER BY population ASC 
LIMIT 10;
...
--Countries with the Highest GDP/This query identifies the countries with the highest Gross National Product (GNP)
...
--Total Surface Area by Continent/This query sums up the total surface area of countries in each continent.
SELECT Continent, SUM(SurfaceArea) AS TotalSurfaceArea
FROM country
GROUP BY Continent
ORDER BY TotalSurfaceArea DESC;

--descriptive analysis of life expectancy in country table
SELECT 
    ...
    STDDEV(LifeExpectancy) AS stddev_life_expectancy
FROM country;

--Country distribution by region & its average population
SELECT region, COUNT(*) AS country_count, AVG(Population) AS avg_population
FROM country
GROUP BY region
...
--head of state analysis
SELECT headofstate, COUNT(*) AS country_count
FROM country
GROUP BY headofstate
ORDER BY country_count DESC;

--urbanization trend. cities with high population/most populous cities
SELECT city.Name AS City, c.Name AS Country, city.Population
FROM city
JOIN country c ON city.countrycode = c.countrycode
ORDER BY city.Population DESC
LIMIT 10;
--top 10 lowest life expectancy age
SELECT Name AS Country, LifeExpectancy
FROM country
ORDER BY LifeExpectancy ASC
LIMIT 10;

--Continent with the Most Countries/This query finds out which continent has the most number of countries.
...
--top 10 highest life expectancy age
SELECT Name AS Country, LifeExpectancy
FROM country
...
--ANALYSIS OF COUNTRYLANGUAGE TABLE

--Total Number of Languages per Country
SELECT countrycode, COUNT(*) AS language_count
FROM countrylanguage
GROUP BY countrycode
ORDER BY language_count DESC;

--Official vs. Non-Official Languages count
SELECT isofficial, COUNT(*) AS language_count
FROM countrylanguage
GROUP BY isofficial;

--official language distribution according to countries
SELECT cl.Language, COUNT(DISTINCT cl.CountryCode) AS NumberOfCountries
...
LIMIT 10;
--countries with number of official languages
SELECT cl.CountryCode, c.Name AS Country, COUNT(cl.Language) AS OfficialLanguages
FROM countrylanguage cl
...
--Least Spoken Languages (By Percentage)
SELECT Language, SUM(Percentage) AS TotalPercentage
FROM countrylanguage
GROUP BY Language
ORDER BY TotalPercentage ASC
LIMIT 10;

--Countries with the Most Languages Spoken-the countries where the highest number of languages are spoken.
...
--Top 10 Languages by Number of Countries Spoken,This query identifies the languages spoken in the most countries.
SELECT Language, COUNT(DISTINCT countrycode) AS NumberOfCountries
FROM countrylanguage
GROUP BY Language
ORDER BY NumberOfCountries DESC
LIMIT 10;
